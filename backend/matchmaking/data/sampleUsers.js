...
const sampleUsers = [
  {
    ...
    graduationYear: 2026,
    instagram: "annadelgado",
    interests: ["ai", "startups", "climbing"],
    tags: ["artificial-intelligence", "entrepreneurship", "climbing", "mentoring"],
    openTo: ["study-buddy", "project-partner", "new-friends"],
  ...
  },
  {
    ...
    graduationYear: 2025,
    instagram: "brycemartin",
    interests: ["robotics", "basketball", "bouldering"],
    tags: ["robotics", "basketball", "climbing", "photography"],
    openTo: ["workout-partner", "project-partner", "new-friends"],
  ...
  },
  {
    ...
    tags: ["machine-learning", "product-design", "volunteering", "photography"],
    openTo: ["study-buddy", "creative-collaboration", "coffee-chat"],
  ...
  },
  {
    ...
    graduationYear: 2026,
    instagram: "dariusbuilds",
    interests: ["startups", "soccer", "podcasts"],
    tags: ["entrepreneurship", "soccer", "podcasts", "coffee"],
    openTo: ["startup-team", "coffee-chat", "new-friends"],
  ...
  },
  {
    ...
    graduationYear: 2025,
    instagram: "erindesigns",
    interests: ["ui/ux", "mentoring", "photography"],
    tags: ["product-design", "user-research", "mentoring", "photography"],
    openTo: ["creative-collaboration", "mentoring", "coffee-chat"],
